...
Agent generated with [`googleCloudPlatform/agent-starter-pack`](https://github.com/GoogleCloudPlatform/agent-starter-pack) version `0.3.4`
...
## Local development with alloy db connection

1. Download alloy auth proxy from [here](https://cloud.google.com/alloydb/docs/auth-proxy/connect).

2. Then start the executable like this

```bash
.\alloydb-auth-proxy.exe projects/qwiklabs-gcp-00-602967da67f6/locations/europe-west1/clusters/alloydb-medication-cluster/instances/primary-instance --public-ip
```
